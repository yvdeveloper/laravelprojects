...
return [
    ...
    */
    ...
    'logo' => '<b>Sugar</b>Tech',
    'logo_img' => 'vendor/adminlte/dist/img/st.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'SugarTech',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url'  => 'helper/datacalculator',
            'icon' => 'fas fa-fw fa-calculator',
        ],
        [
            'text' => 'Earnings Calculator',
            'url'  => 'helper/earningscalculator',
            'icon' => 'fas fa-fw fa-calculator',
        ]
        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/DataTables/DataTables-1.13.8/js/jquery.dataTables.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/DataTables/DataTables-1.13.8/js/dataTables.bootstrap4.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/DataTables/DataTables-1.13.8/css/dataTables.bootstrap4.min.css',
                ],
            ],
        ],
        'Select2' => [
